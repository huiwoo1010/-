...
const qnaList = [
  {
    q: '1. 뛰어놀기 좋아하시나요?',
    a: [
      { answer: 'a. 넹', type: [1, 2, 4, 9] },
      { answer: 'b. soso', type: [0, 3, 6, 5, 10, 8] },
      { answer: 'c. 아니여', type: [7, 11 ] },
    ]
  },
  {
    q: '2. 친구들과 소통이 활발한 편인가요?',
    a: [
      { answer: 'a. 당연', type: [0, 3, 2, 8] },
      { answer: 'b. 그럴듯.', type: [1, 6, 5, 10] },
      { answer: 'c. 아닐수도', type: [7, 4, 9, 11] },
    ]
  },
  {
    q: '3. 닌 바보인가?',
    a: [
      { answer: 'a. 그런거같다', type: [1, 3, 2, 10, 8] },
      { answer: 'b. 심각하다', type: [7, 9, 11] },
      { answer: 'c. ㄹㅇ 그렇다', type: [0, 6, 5, 4] }
    ]
  },
  {
    q: '4. 배고프다',
    a: [
      { answer: 'a. ㅇㅉㄹㄱ ', type: [1, 2, 4 ] },
      { answer: 'b. ㄴㄷ ', type: [7, 10, 8, 9, 11 ] },
      { answer: 'c. ㅋ ', type: [0, 3, 6, 5 ] },
    ]
  },
  {
    q: '5. ㅁㅎㄴ',
    a: [
      { answer: 'a. ㅁㄹ', type: [1, 7, 10, 4, 9 ] },
      { answer: 'b. 공부', type: [0, 3, 6, 11]},
      { answer: 'c. 뒹굴', type: [2, 5, 8] },
    ]
  },

  {
    q: '6. 에베베',
    a: [
      { answer: 'a. 우헤헤', type: [4, 9, 11 ] },
      { answer: 'b. ㅆㅎㅅ', type: [0, 3, 6, 10 ] },
      { answer: 'c. ㅔ휴', type: [1, 7, 2, 5, 8 ] },
    ]
  },
  {
    q: '7. 임기영 알람을 죽이자',
    a: [
      { answer: 'a. ㄱ', type: [1, 7, 11 ] },
      { answer: 'b. ㄱㄱ', type: [2, 4, 9 ] },
      { answer: 'c. ㄱㄱㄱ', type: [0, 3, 6, 5, 10, 8 ] },
    ]
  },
  {
    q: '8. 인공프 주제 머하지',
    a: [
      { answer: 'a. 완전히 소프트웨어로', type: [0, 4, 9 ] },
      { answer: 'b. 하드웨어 첨가', type: [3, 2, 6, 5, 10, 8 ] },
      { answer: 'c. 생', type: [1, 7, 11 ] },
    ]
  },
  {
    q: '9. 선대 듣기 싫다',
    a: [
      { answer: 'a. ㄹㅇ', type: [7, 0, 5, 9 ] },
      { answer: 'b. ㄹㅇㅋ', type: [1, 3, 6, 11 ] },
      { answer: 'c. ㄹㅇㅋㅋ', type: [2, 10, 8, 4 ] },
    ]
  },
  {
    q: '10. 아몰랑',
    a: [
      { answer: 'a. 나도 몰라', type: [4, 9, 11] },
      { answer: 'b. ㅊㅋ', type: [0, 2, 6, 5 ] },
      { answer: 'c. 우갸갸', type: [1, 7, 3, 10, 8 ] },
    ]
  },
  {
    q: '11. rc카 만들고 싶다',
    a: [
      { answer: 'a. ㅇㅇㄴㅇ', type: [1, 4, 9, 11 ] },
      { answer: 'b. 불가능', type: [7, 0, 3, 6, 10] },
      { answer: 'c. ㅋ', type: [2, 5, 8 ] },
    ]
  },
  {
    q: '12. 마지막',
    a: [
      { answer: 'a. 개꿀', type: [3, 6, 4, 9 ] },
      { answer: 'b. 힘들었다', type: [0, 2, 5, 10, 8] },
      { answer: 'c. ㅊㅋ', type: [1, 7, 11] },
    ]
  }
]
const infoList = [
  {
    name: '정보 전달자 <뉴런>',
    desc: '뉴런은 이온 통로를 통해 전기 신호를 전달하고, 시냅스를 통해 화학 신호를 주고 받아 다양한 정보를 전달하는 역할을  수행합니다. 120m/s의 흥분전달속도를 갖는 뉴런만큼이나 빠른 정보 전달의 매개체인 당신은 항상 열린 귀로 주변 사람들의 소식에 귀를 기울이고 학교 곳곳에 소식을 전달해줍니다. 당신이 없으면 느려지는 소통에 모두가 답답해 할 거에요! '
  },
  {
